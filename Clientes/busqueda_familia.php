...
if(isset($_POST['parametros'])){
	...
	$sql = "select * from demosistreal.familias where nombre like '".$dato."%' and id != 105 order by nombre asc";
}
else{
	$sql = "select * from demosistreal.familias where id != 105 order by nombre asc";	
}
		...
		<div class="card shadow" id="card-familia">
          ...
          <div id="<?php echo $nombrecollapse."".$i ?>" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
            <div class="panel-body">
              ...
              ?> 
              <button type="button" onclick='muestra_detalle_pedido(<?php echo $preaparado['id'] ?>, <?php echo $vta_id ?>, <?php echo $npedid ?>)' class="btn btn-success" aria-label="Left Align" data-toggle="modal" data-toggle="modal" data-target="modal" data-whatever="@mdo">
                   <?php echo $preaparado['nombre']." - $".number_format($preaparado['precio'], 0, ',', '.') ?>
                  </button>
              <?php
              }
              ?>
