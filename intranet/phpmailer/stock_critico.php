...
$criticos = get_stocks_criticos();
// foreach ($criticos as $key => $critico) {
// 	echo "NOMBRE->".$critico['nombre'].", STOCK->".$critico['stock'].", MIN->".$critico['min']."<br>";
// }

if(is_array($criticos))
  enviarcorreostock($criticos);

function enviarcorreostock($criticos){
                ...
                <table cellpadding='0' cellspacing='0' width='600' class='w320'>
                  <tr>
                    <td class='pull-left mobile-header-padding-left' style='vertical-align: middle;'>
                      <a href=''><img width='200' height='200' src='https://ayahuaska.realdev.cl/assets/img/brand/logo.png' alt='logo'></a>
                    </td>
    ...
    <td align='center' valign='top' width='100%' style='background-color: #f7f7f7;' class='content-padding'>
      <center>
        <table cellspacing='0' cellpadding='0' width='600' class='w320'>
          ...
          <tr>
            <td class='free-text'>
              Estimado, RealDev reporta stock ".utf8_decode('crítico')." de producto(s) en SISTEMA.
            </td>
          </tr>
          <tr>
            <td class='button'>
    ...
    $mensaje .= "<tr>
                    <td class='item-col item'>
                      <table cellspacing='0' cellpadding='0' width='100%'>
                        <tr>
                          <td class='product'>
                            <span style='color: #4d4d4d; font-weight:bold;'>".utf8_decode($critico['nombre'])."</span> 
                          </td>
                        </tr>
                      </table>
                    </td>
