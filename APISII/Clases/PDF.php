...
class PDF extends TCPDF
{
     ...
     * @version 2016-03-20
     */
    public function __construct($o = 'P', $u = 'mm', $s = 'LETTER', $top = 0, $cli = '', $nombre = '', $rut = '')
    {
    ...
    public function Footer()
    {
        if (is_array($this->footer) and (!empty($this->footer['left']) or !empty($this->footer['right']))) {
            $style = ['width' => 2, 'cap' => 'butt', 'join' => 'miter', 'dash' => 0, 'color' => [50, 50, 50]];
     ...
     * @version 2018-04-15
     */
    public function addNormalTable(array $headers, array $data, array $options = [])
    {
    ...
    public function Texto($txt, $x=null, $y=null, $align='', $w=0, $link='', $border=0, $fill=false)
    {
        ...
        $this->Ln();
        $this->Ln();
        $this->Cell(100, 3, $txt, $border, 0, 'L');
