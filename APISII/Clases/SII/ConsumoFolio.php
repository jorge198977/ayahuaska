...
require_once 'Base/Libro.php';

class ConsumoFolio extends Libro
{
    ...
    public function setCaratula(array $caratula)
    {
        ...
        $this->id = 'REPORTE_CONSUMO_FOLIO_'.str_replace('-', '', $this->caratula['RutEmisor']).'_'.str_replace('-', '', $this->caratula['FchInicio']).'_'.date('U');
    }
    ...
    public static function generarConsumoFolio()
    {
