                      ...
                      <table id="example1" class="table table-flush">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><?php echo $cc['onzas'] ?></td>
                            <td align="center">
                                <a onclick="return (confirmDel(<?php echo $cc['id'] ?>));">
                                  <button type="button" name="btnelimbeb" value="btnelimbeb" class="btn btn-default"  aria-label="Left Align">
                                  <span class="fas fa-trash" aria-hidden="true"></span>
                                  </button>
                                </a>
                                <button type="button" onclick='muestra_modal(<?php echo $cc['id'] ?>)' class="btn btn-default" aria-label="Left Align" data-toggle="modal" data-toggle="modal" data-target="modal" data-whatever="@mdo">
  ...
  <script type="text/javascript">
    function confirmDel(id){
        ...
        callback: function (result) {
            if(result){
              location.href = "../../intranet/funciones/procesamoderador2.php?ElimidCc="+id+""; 
            }
            else{
