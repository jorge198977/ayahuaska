...
include("../../intranet/funciones/controlador.php");
  ...
  $z = 0;
      ...
      $sql = "select * from ayahuaska.familias where nombre like '%".$_POST['parametros']."%' order by nombre asc";
    }
    else{
      $sql = "select * from ayahuaska.familias order by nombre asc";
   	...
   	<div class="row">
	   	...
	   	while($dat = mysql_fetch_array($res)){
	   		...
	   		$sql2 = "select PREPARADOS_ID from ayahuaska.preparados where PREPARADOS_FAMILIA = ".$dat['id']."";
	   	...
	   	?>	
	          ...
	          <div class="card card-stats mb-2 mb-xl-0">
	            <a href="visualiza_producto_preparado.php?Familia=<?php echo $dat['id'] ?>">
	              <div class="card-body">
	                <div class="row">
	                  <div class="col">
