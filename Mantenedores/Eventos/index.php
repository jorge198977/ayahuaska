                     ...
                     <div class="table-responsive">
                      <table id="example1" class="table table-flush">
                        ...
                        <tbody>
                          ...
                          ?> 
                            <tr>
                              <th><?php echo $evento['nombre'] ?></th>
                              <th><?php echo fecha_bd_normal($evento['fecha']) ?></th>
                              <th>
                                <?php 
                                  if($evento['estado'] == 0){
                                    $estado = "ACTIVO";
                              ...
                              <th>
                                <a onclick="return confirmDel();" href="../../intranet/funciones/procesar_evento.php?Ideventoelim=<?php echo $evento['id'] ?>">
                                ...
                                <button type="button" onclick='muestra_modal(<?php echo $evento['id'] ?>)' class="btn btn-default" aria-label="Left Align" data-toggle="modal" data-toggle="modal" data-target="modal" data-whatever="@mdo">
                ...
                <div id="myModal5" class="modal fade" role="dialog">
                  <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                      <form  name="miform" id="form1" method="post" action="../../intranet/funciones/procesar_evento.php" enctype="multipart/form-data">
