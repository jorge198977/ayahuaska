              ...
              <div class="card shadow">
                     ...
                     <div class="table-responsive">
                      <table id="example1" class="table table-flush">
                        ...
                        <tbody>
                          ...
                          ?> 
                          <tr>
                            <th><?php echo $socio['rut'] ?></th>
                            <th><?php echo $socio['nombre'] ?></th>
                           
                            <th><?php echo $socio['telefono'] ?></th>
                           
                            <th>
                              <?php if(($_SESSION['tipo'] == 1) or ($_SESSION['tipo'] == 2)){ ?>
                                <a onclick="return (confirmDel(<?php echo $socio['id'] ?>));">
                                  <button type="button" name="btnelimbeb" value="btnelimbeb" class="btn btn-default"  aria-label="Left Align">
                                  <span class="fas fa-trash" aria-hidden="true"></span>
                                  </button>
                                </a>
                              <?php } ?>
                              <button type="button" onclick='muestra_modal(<?php echo $socio['id'] ?>)' class="btn btn-default" aria-label="Left Align" data-toggle="modal" data-toggle="modal" data-target="modal" data-whatever="@mdo">
                ...
                <div class="container">
                  <div class="row">
                    ...
                    <div class="col">
                      <a href="../../Reportes/Impresiones/ImprimeReporte.php?Socioreal" target="_blank" target="_blank"><button type="button" class="btn btn-success btn-block my-4">Reporte</button></a>
                    </div>
                    <div class="col">
                    ...
                    <div class="modal-content">
                      <form  name="miform" id="form1" method="post" action="../../intranet/funciones/procesamoderador2.php" >
                        <div class="modal-header">
                          <h4 class="modal-title">SOCIOS</h4>
                        </div>
  ...
  <script type="text/javascript">
    function confirmDel(id){
        ...
        callback: function (result) {
            if(result){
              location.href = "../../intranet/funciones/procesamoderador2.php?Elimsocio="+id+""; 
            }
            else{
