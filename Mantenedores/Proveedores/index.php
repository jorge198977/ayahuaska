              ...
              <div class="card shadow">
                     ...
                     <div class="table-responsive">
                      <table id="example1" class="table table-flush">
                        ...
                        <tbody>
                          ...
                          ?> 
                          <tr>
                            <th><?php echo $prov['rol'] ?></th>
                            <th><?php echo $prov['nombre'] ?></th>
                            <th><?php echo $prov['fono'] ?></th>
                            <th><?php echo $prov['correo'] ?></th>
                            <th>
                              <?php  
                                if($prov['estado'] == 0){
                                  echo "ACTIVO";
                            ...
                            <th>
                                <a onclick="return (confirmDel(<?php echo $prov['id'] ?>));">
                                  <button type="button" name="btnelimbeb" value="btnelimbeb" class="btn btn-default"  aria-label="Left Align">
                                  <span class="fas fa-trash" aria-hidden="true"></span>
                                  </button>
                                </a>
                                  <button type="button" onclick='muestra_modal(<?php echo $prov['id'] ?>)' class="btn btn-default" aria-label="Left Align" data-toggle="modal" data-toggle="modal" data-target="modal" data-whatever="@mdo">
                ...
                <div class="container">
                  <div class="row">
                    ...
                    <div class="col">
                      <a href="../../Reportes/Impresiones/ImprimeReporte.php?repProveedores" target="_blank" target="_blank"><button type="button" class="btn btn-success btn-block my-4">Reporte</button></a>
                    </div>
                    <div class="col">
  ...
  <script type="text/javascript">
    function confirmDel(id){
        ...
        callback: function (result) {
            if(result){
              location.href = "../../intranet/funciones/procesamoderador2.php?ElimidProv="+id+""; 
            }
            else{
