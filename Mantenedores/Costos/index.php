        ...
        <div class="header-body">
          ...
          <div class="row">
                ...
                <a href="tipos_costos.php">
                  <div class="card-body">
                    ...
                    <p class="mt-3 mb-0 text-muted text-sm">
                      ...
                      <span class="text-nowrap">Ingresa Nuevo Tipo Costo</span>
                    </p>
                  </div>
                </a>
              </div>
            ...
            <div class="col-xl-3 col-lg-6">
              ...
              ?>
              <div class="card card-stats mb-4 mb-xl-0">
                <a href="costos.php?id=<?php echo $tipo_costo['id'] ?>">
                  <div class="card-body">
                    <div class="row">
                      <div class="col">
                        <h3 class="card-title text-uppercase text-muted mb-0"><?php echo $tipo_costo['nombre'] ?></h3>
                        <span class="h2 font-weight-bold mb-0"></span>
                      </div>
                      <div class="col-auto">
