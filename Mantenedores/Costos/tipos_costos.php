            ...
            <div class="col-12">
              <div class="card shadow">
                <div class="card-header border-0">
                  <h3 class="mb-0">TIPOS DE COSTOS</h3>
                </div>
                    ...
                    <div class="box-body">
                     <div class="table-responsive">
                      <table id="example1" class="table table-flush">
                        ...
                        <tbody>
                          <?php
                            foreach ($tipos_costos as $key => $tipo_costo) {
                          ?> 
                            <tr class="active">
                              <th><?php echo $tipo_costo['nombre'] ?></th>
                              <th>
                                 <a onclick="return (confirmDel(<?php echo $tipo_costo['id'] ?>));">
                                  <button type="button" name="btnelimbeb" value="btnelimbeb" class="btn btn-default"  aria-label="Left Align">
                                  <span class="fas fa-trash" aria-hidden="true"></span>
                                  </button>
                                </a>
                                  <button type="button" onclick='muestra_modal(<?php echo $tipo_costo['id'] ?>)' class="btn btn-default" aria-label="Left Align" data-toggle="modal" data-toggle="modal" data-target="modal" data-whatever="@mdo">
                    ...
                    <div class="modal-content">
                      <form  name="miform" id="form1" method="post" action="../../intranet/funciones/procesamoderador2.php" >
                        <div class="modal-header">
                          <h4 class="modal-title">TIPO COSTO</h4>
                        </div>
    ...
    <script type="text/javascript">
      function confirmDel(id){
          ...
          callback: function (result) {
              if(result){
                location.href = "../../intranet/funciones/procesamoderador2.php?ElimTipoCosto="+id+""; 
              }
              else{
