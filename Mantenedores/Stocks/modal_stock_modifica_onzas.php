...
<label for="observacion" class="col-sm-xs-2 control-label">ONZAS EQUIVALENTES</label>
<div class="col-sm-xs-10">
  <input type="text" name="stockonzas" value="<?php echo $_POST['stockonza'] ?>" class='form-control' disabled>
</div>
<hr>
...
<input type="hidden" name="stockOnzas" value="<?php echo $_POST['stockonza'] ?>">
<input type="hidden" name="tipo_descuento" value="2">
