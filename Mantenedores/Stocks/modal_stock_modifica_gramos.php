...
<label for="observacion" class="col-sm-xs-2 control-label">GRAMOS EQUIVALENTES</label>
<div class="col-sm-xs-10">
  <input type="text" name="stockonzas" value="<?php echo $_POST['stockgramos'] ?>" class='form-control' disabled>
</div>
<hr>
...
<input type="hidden" name="stockgramos" value="<?php echo $_POST['stockgramos'] ?>">
<input type="hidden" name="tipo_descuento" value="3">
