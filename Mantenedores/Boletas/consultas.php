        ...
        <div class="header-body">
          ...
          <div class="row">
                ...
                <a href="consulta_folio.php">
                  <div class="card-body">
                    ...
                    <p class="mt-3 mb-0 text-muted text-sm">
                      ...
                      <span class="text-nowrap">Consulta Folio</span>
                    </p>
                  </div>
                </a>
              </div>
            ...
            <div class="col-xl-3 col-lg-6">
              <br>
              <div class="card card-stats mb-4 mb-xl-0">
                <a href="consulta_trackid.php">
                  <div class="card-body">
                    <div class="row">
                      <div class="col">
                        <h3 class="card-title text-uppercase text-muted mb-0">TRACKID</h3>
                        <span class="h2 font-weight-bold mb-0"></span>
                      </div>
                      <div class="col-auto">
                    ...
                    <p class="mt-3 mb-0 text-muted text-sm">
                      <span class="text-success mr-2"><i class=""></i></span>
                      <span class="text-nowrap">Consulta Trackid</span>
                    </p>
                  </div>
                </a>
              </div>
