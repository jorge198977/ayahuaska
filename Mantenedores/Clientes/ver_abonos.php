                     ...
                     <div class="table-responsive">
                      <table id="example1" class="table table-flush">
                        ...
                        <tbody>
                          ...
                          ?> 
                            <tr>
                                <th><?php echo $abono['cliente_id']; ?></th>
                                <th><?php echo $cliente['nombre']; ?></th>
                                <th><?php echo $abono['nume']; ?></th>
                                <th><?php echo $abono['glosa']; ?></th>
                                <th><?php echo substr($abono['fecha'], 8, 2)."-".substr($abono['fecha'], 5, 2).
                                      "-".substr($abono['fecha'], 0, 4); ?></th>
                                <th><?php echo number_format($abono['abono'], 0, ',', '.'); ?></th>
                            </tr>
                          <?php
                            }
                          ?>
