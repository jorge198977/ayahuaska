   ...
   <div class="table-responsive">
    ...
    <div class="panel-body">
      <div class="col-lg-12 text-center">
        ...
        <input type="text" name="descuentomonto" id="descuentomonto" value="<?php echo $descuentomonto ?>" class='form-control' required>
        <input class="form-control input-lg" name="ototal" id="ototal" type="hidden" value="<?php echo $total-$descu - $sumatoria_descuento - $descuento_puntos ?>" >
        <input class="form-control input-lg" name="descuentomov" type="hidden" value="<?php echo $id ?>" >
      </div>
    </div>
