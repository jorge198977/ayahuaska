...
<div class="container">
    <div class="row">
      	<div class="col-12">
			...
			if($ret == 1){
				$sql = "select * from sheol2.preparados where PREPARADOS_NOMBRE like '%".$dato."%' order by PREPARADOS_NOMBRE asc";
			}
			else{
			  $sql = "select * from sheol2.preparados where PREPARADOS_NOMBRE like '%".$dato."%' and PREPARADOS_NOMBRE not like '%HAPPY%' order by PREPARADOS_NOMBRE asc";
			}
