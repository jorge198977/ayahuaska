                    ...
                    <div class="col-sm">
                        ...
                        <form method="post" name="frmcerrar" action="../intranet/funciones/procesapedido2.php">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                <a href="venta_cover.php?id=<?php echo $_GET['Mov'] ?>"><button type="button" class="btn btn-danger btn-block my-4">Volver</button></a>
                              </div>
                            </div>
                          </div>
                        </form>
  ...
  <script type="text/javascript">
    function confirmaPago(id){
        ...
        callback: function (result) {
            if(result){
              location.href = "../intranet/funciones/procesapedido2.php?btnpagarpedidoentrada&ototalmenosdescu="+frmcerrar.ototalmenosdescu.value+"&propina=0&omov="+id+"&omesa="+frmcerrar.omesa.value+"&monto_pagado="+frmcerrar.monto_pagado.value+"&fpago="+frmcerrar.fpago.value+"&nomcli="+frmcerrar.nomcli.value+"&boleta="+frmcerrar.boleta.value+""; 
            }
            else{
