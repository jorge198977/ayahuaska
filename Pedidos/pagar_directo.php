...
$(document).ready(function(){
  ...
  $vuelto.val(
    ...
    if(parseInt($montopagado.val()) >= parseInt($totcpropina.val())){
      frmcerrar.btnpagarpedidoentrada.disabled = false;
    }
  });
            ...
            <div class="col">
              <div class="card shadow">
                <div class="card-header border-0">
                  <h3 class="mb-0">VENTA DE ENTRADA</h3>
                </div>
                          ...
                          <div class="row">
                            <div class="col-md-6">
                              <div class="form-group">
                               ...
                               <!--  <button type="submit" name="btnpagarpedidoentrada" id="btnpagarpedidoentrada" disabled="true" onClick="return validar()" class="btn btn-lg btn-success btn-block my-4">PAGAR</button> -->
                                <a onclick="return (confirmaPago(<?php echo $_GET['Mov'] ?>));">
                                    <button type="button" name="btnpagarpedidoentrada" id="btnpagarpedidoentrada" disabled="true" class="btn btn-lg btn-success btn-block my-4">
                                    PAGAR
                                    </button>
                                </a>
                              </div>
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                <a href="venta_directa.php?id=<?php echo $_GET['Mov'] ?>"><button type="button" class="btn btn-danger btn-block my-4">Volver</button></a>
                              </div>
                            </div>
                          </div>
                        </form>
...
<script src="../js/bootbox.min.js"></script>
  <script type="text/javascript">
    function confirmaPago(id){
        var fp = "";
        frmcerrar.btnpagarpedidoentrada.disabled = true;
        ...
        callback: function (result) {
            if(result){
              location.href = "../intranet/funciones/procesapedido2.php?btnpagarpedidodirecto&ototalmenosdescu="+frmcerrar.ototalmenosdescu.value+"&propina=0&omov="+id+"&omesa="+frmcerrar.omesa.value+"&monto_pagado="+frmcerrar.monto_pagado.value+"&fpago="+frmcerrar.fpago.value+"&nomcli="+frmcerrar.nomcli.value+"&boleta="+frmcerrar.boleta.value+""; 
            }
            else{
