            ...
            <div class="card-body">
                <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="col-md-12">
                                      <div class="form-group">
                                        <div class="input-group mb-4">
                                          ...
                                          <input class="form-control" name="busqueda_familia" id="busqueda_familia" placeholder="Buscar" type="text">
                                        </div>
                                      </div>
                                    </div>
                                  </div>
                    ...
                    <div class="tab-pane fade" id="tabs-icons-text-2" role="tabpanel" aria-labelledby="tabs-icons-text-2-tab">
                        <div class="col">
                          <?php
                            $vta_detalles = get_ventas_detalles_by_id_npedido($_GET['id'], 1);
                          ?>
                          <div class="card shadow">
                                ...
                                <tbody>
                                  ...
                                  ?>
                                    <tr>
                                      ...
                                      <td>
                                        <a href="../intranet/funciones/procesapedido2.php?Elimpedidotabla3=<?php echo $vta_detalle['id'] ?>&vta_id=<?php echo $_GET['id'] ?>&npedido=1">
                          ...
                          ?>
                            ...
                            <div class="card-footer py-4">
                              <nav aria-label="...">
                                <!-- <a href="../intranet/funciones/generarpedidocover.php?mov=<?php echo $_GET['id'] ?>" onclick="block()">
                                  <button type="button" name="imprimepedido" id="imprimepedido" class="btn btn-success btn-lg btn-block my-4" value="imprimepedido" >PAGAR PEDIDO</button>
                                </a> -->
                                  <a href="pagar_cover.php?Mov=<?php echo $_GET['id'] ?>" onClick="return validar()">
                ...
                <nav aria-label="...">
                    <a href="../intranet/funciones/procesapedido2.php?volverentrada=<?php echo $_GET['id'] ?>"><button type="button" class="btn btn-danger btn-block my-4">Volver</button></a>
                </nav>
            </div>
        </div>
      </div>
     ...
     $(document).ready(function(){
         $("#busqueda_familia").keyup(function(){
              ...
              $.ajax({
                    ...
                    url:   'busqueda_familia_cover.php',
                    type:  'post',
                      beforeSend: function () { },
                      success:  function (response) {                 
                          $('#muestra_familias_cover').html(response);
                    },
                    error:function(){
                         alert("error")
                      }
