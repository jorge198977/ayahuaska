  ...
  <div class="main-content">
    ...
    <?php
         if(isset($_GET['fechai'])){
            ...
            $cierres = get_cierres_por_fecha_merma($fechahoy, $fechafinal);                         
          ...
          <div class="row">
            <div class="col-12">
              <div class="card shadow">
                ...
                <form name="frmfiltro" method="get" action="canjes.php">
                  <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        <div class="input-group mb-4">
                          ...
                          <input type="date" class="form-control" name="fechaf" id="fechaf" placeholder="Ingrese Fecha Final"
                            >
                        </div>
                      </div>
                    </div>
