  ...
  <div class="main-content">
    ...
    <?php
      if(isset($_GET['fechai'])){
        $propinas = get_detalle_propinas_garzones_turno($_GET['fechai'], $_GET['turno']);  
      }
    ?>
            ...
            <div class="col-12">
              <div class="card shadow">
                <div class="card-header border-0">
                  <h3 class="mb-0">PROPINAS DE GARZONES POR TURNO</h3>
                </div>

                <form name="frmfiltro" method="get" action="propinas_turno.php">
                  <div class="row">
                    <div class="col-md-6">
