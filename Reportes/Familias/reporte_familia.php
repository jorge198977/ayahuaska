...
<body>
  ...
  <div class="main-content">
    ...
    <?php
      $familia = get_familia($_GET['id']);
      if(isset($_GET['fechai'])){
        $familias_reportes = get_reportes_familias_fecha($_GET['id'], $_GET['fechai'], $_GET['fechaf']); 
      }
    ?>
            ...
            <div class="col-12">
              <div class="card shadow">
                <div class="card-header border-0">
                  <h3 class="mb-0">REPORTE DE <?php echo $familia;  ?></h3>
                </div>

                <form name="frmfiltro" method="get" action="reporte_familia.php">
                  <div class="row">
                    <div class="col-md-6">
                     ...
                     <div class="table-responsive">
                      <table id="example1" class="table table-flush">
                        ...
                        <tbody>
                          ...
                          ?> 
                          <tr>
                              <th><?php echo $familia_reporte['preparado_nombre'] ?></th>
                              <th><?php echo $familia_reporte['cantidad'] ?></th>
                              <th><?php echo number_format($familia_reporte['preparado_precio'], 0, ',', '.') ?></th>
                              <th><?php echo number_format($subtotal, 0, ',', '.') ?></th>
                          </tr>
                          <?php
                             $propin[] = array('y' => $familia_reporte['cantidad'], 'label' => $familia_reporte['preparado_nombre'] );
                          }
                          ?>
                        </tbody>
                      </table>
                ...
                <div class="container">
                  <div class="row">
                    <div class="col-md-6">
                      <a <?php if(isset($_GET['fechai'])){ ?> href="../Impresiones/ImprimeReporte.php?verRepFamilia&Familia=<?php echo $_GET['id'] ?>&Fechai=<?php echo $_GET['fechai'] ?>&Fechaf=<?php echo $_GET['fechaf'] ?>" target="_blank" target="_blank" <?php } ?>><button type="button" class="btn btn-success btn-block my-4">Reporte</button></a>
                    </div>
                    <div class="col-md-6">
